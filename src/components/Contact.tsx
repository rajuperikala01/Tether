...
export default function Contact({ id, firstName, lastName }: contact) {
  return (
    <div className="h-14 w-[97%] md:w-[95%] flex px-3 items-center justify-between mt-1 hover:bg-neutral-800 rounded-sm">
